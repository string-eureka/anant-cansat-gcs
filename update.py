...
while True:
    ...
    if T_MIN == 60:
        T_HOUR += 1
        T_MIN = 0
    GAS_ALT, ESP_TIME, IACC_Z, GPS_STATUS, GPS_LAT, GPS_LNG, GPS_HR, GPS_MIN, GPS_SEC, IACC_X, IACC_Y, IMAG_X, IMAG_Y, IMAG_Z, GAS_PRS, GAS_TEMP, GPS_ALT, CHECKSUM = [random.uniform(1,100) for _ in range(18)]
    time.sleep(1)
